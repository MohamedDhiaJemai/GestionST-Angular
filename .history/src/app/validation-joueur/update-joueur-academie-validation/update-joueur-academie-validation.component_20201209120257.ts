...
export class UpdateJoueurAcademieValidationComponent implements OnInit {
  ...
  showViaServicePhotoWait() {
    this.messageService.clear();
    this.messageService.add({ key: 'photo', severity: 'warn', summary: 'EN Cours De Traitement' });
  }
  ...
  showViaServicePhotoEror() {
    this.messageService.clear();
    this.messageService.add({ key: 'photo', severity: 'error', summary: 'Problème d Enregistement' });
  }
