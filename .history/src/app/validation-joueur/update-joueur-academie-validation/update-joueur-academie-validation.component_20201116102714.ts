...
export class UpdateJoueurAcademieValidationComponent implements OnInit {
  ...
  showViaServiceWait(key: string) {
    if (key == "personnel") {
      ...
      this.messageService.clear();
      this.messageService.add({ key: 'salaire', severity: 'warn', summary: 'Info Message', detail: '  Upload de fichier en cours'});
    }
    else {
      this.messageService.clear();
      this.messageService.add({ key: 'conge', severity: 'warn', summary: 'Info Message', detail: '  Upload de fichier en cours' });
    }
  }

  showViaServiceOk(data: number, key: string) {
    if (key == "personnel") {
      this.messageService.clear();
      ...
      this.messageService.clear();
      this.messageService.add({ key: 'salaire', severity: 'success', summary: 'Success', detail: 'Message Content : nombre de lignes insérées ' + data });
    }
    else {
      this.messageService.clear();
      this.messageService.add({ key: 'conge', severity: 'success', summary: 'Success', detail: 'Message Content : nombre de lignes insérées ' + data });
    }
  }
  ...
  showViaServiceEror(key: string) {
    if (key == "personnel") {
      ...
      this.messageService.clear();
      this.messageService.add({ key: 'salaire', severity: 'error', summary: 'Error', detail: 'Message Content : Problème d\'insérision' });
    }
    else {
      this.messageService.clear();
      this.messageService.add({ key: 'conge', severity: 'error', summary: 'Error', detail: 'Message Content : Problème d\'insérision' });
    }
