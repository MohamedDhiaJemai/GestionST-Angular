...
export class UpdateJoueurAcademieValidationComponent implements OnInit {
  ...
  ngOnUpdateJoueurAcademie(templateAnnulation: TemplateRef<any>) {
    ...
    this.joueurAcademie.dateValidation = this.datePipe.transform(this.dateSytem, 'yyyy-MM-dd HH:mm'))
    // this.joueurAcademie.dateValidation = this.datePipe.transform(date, '')
