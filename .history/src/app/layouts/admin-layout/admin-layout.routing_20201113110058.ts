...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'add-joureur-professionnel', component: AddJoueurProComponent },
    ...
    { path: 'add-jouteur-academie', component: AddJoueurAcademieComponent },
    { path: 'consulter-jouteur-academie/:id', component: ConsulterJoueurAcademieComponent },
    { path: 'update-jouteur-academie/:id', component: UpdateJoueurAcademieComponent },
