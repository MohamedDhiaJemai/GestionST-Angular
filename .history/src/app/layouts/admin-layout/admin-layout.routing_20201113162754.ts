...
import { ValidationJoueurAcademieComponent } from 'app/validation-joueur-academie/validation-joueur-academie.component';
import { UpdateJoueurAcademieValidationComponent } from 'app/validation-joueur-academie/update-joueur-academie-validation/update-joueur-academie-validation.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'validation-joueur', component: ValidationJoueurAcademieComponent },
    { path: 'validation-joueur-academie', component: ValidationJoueurAcademieComponent },
