...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'add-service', component: AddArticleComponent },
    { path: 'consulter-service/:id', component: ConsulterArticleComponent },
    { path: 'update-service/:id', component: UpdateArticleComponent },
