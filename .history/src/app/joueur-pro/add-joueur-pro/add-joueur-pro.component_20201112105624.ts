...
export class AddJoueurProComponent implements OnInit {
  ...
  onAddJoueurPro() {
    const newDate = new Date(this.datePipe.transform(this.joueurPro.dateNaissance, "yyyy-MM-dd"));
    this.joueurPro.dateNaissance = newDate;
    console.log('Professionnel', this.joueurPro.dateNaissance)
