  ...
  ngOnInit() {
    ...
    this.articleService.findById(id).subscribe(
      data => {
        ...
        this.approvisionnement.article.id = data.id;
        this.approvisionnement.article.libelle = data.libelle;
        this.approvisionnement.article.prix = data.prix;
        this.approvisionnement.article.quantite = data.quantite;
        this.approvisionnement.article.sexe = data.sexe;
      }
    );
  }
