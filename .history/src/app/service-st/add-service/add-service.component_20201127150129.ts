...
export class AddServiceComponent implements OnInit {
  ...
  serviceSTComplement: ServiceStComplementaireComponent = new ServiceStComplementaireComponent();
  ...
  onAddServiceComplementaire() {
    console.log(this.serviceSTComplement);
    
    this.serviceSTService.addServiceComplement(this.serviceSTComplement).subscribe(
      data => {
        // this.upload(photo, this.serviceST.id); 
        this.routerNav.navigate(['services'])
      },
